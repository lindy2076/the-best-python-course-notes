...
При сложении последовательностей и при сложении чисел будут [вызываться](https://github.com/python/cpython/blob/main/Objects/abstract.c#L1138) разные сишные слоты:
